...
export default function Updater(): null {
  ...
  useEffect(() => {
    ...
    if (chainId && [SupportedChainId.CANDLE, SupportedChainId.CANDLE].includes(chainId)) {
      dispatch(enableList(WLKR_LIST))
    }
  ...
  useInterval(fetchAllListsCallback, library ? 100 * 60 * 10 : null)
