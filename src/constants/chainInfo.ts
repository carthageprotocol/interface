...
export const CHAIN_INFO: ChainInfoMap = {
  [SupportedChainId.MAINNET]: {
    ...
    infoLink: 'https://info.carthagedex.com/#/',
    label: 'Ethereum',
  ...
  [SupportedChainId.OPTIMISM]: {
    ...
    infoLink: 'https://info.carthagedex.com/#/optimism/',
    label: 'Optimism',
  ...
  [SupportedChainId.ARBITRUM_ONE]: {
    ...
    infoLink: 'https://info.carthagedex.com/#/arbitrum',
    label: 'Arbitrum',
  ...
  [SupportedChainId.POLYGON]: {
    ...
    infoLink: 'https://info.carthagedex.com/#/polygon/',
    label: 'Polygon',
