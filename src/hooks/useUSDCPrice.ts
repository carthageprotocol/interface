...
import { DAI_OPTIMISM, USDC_ARBITRUM, USDC_MAINNET, USDC_POLYGON, DAI_CANDLE } from '../constants/tokens'
...
export const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [SupportedChainId.CANDLE]: CurrencyAmount.fromRawAmount(DAI_CANDLE, 10_0000e6),
}
